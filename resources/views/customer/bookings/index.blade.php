                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            @if($booking->status === 'completed' && !$booking->review)
                                                <a href="{{ route('customer.reviews.create', $booking) }}" class="text-indigo-600 hover:text-indigo-900">Leave Review</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-4 text-center text-gray-500">
                                            ...
                                            <a href="{{ route('services.index') }}" class="text-indigo-600 hover:underline">Browse Services</a>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
